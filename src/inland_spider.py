...
class getPageSelenium():
    ...
    def __init__(self):
        ...
        self.common_brand = ['相宜本草','佰草集','自然堂','大宝','美加净','水密码','一叶子','上海女人','欧诗漫']
    ...
    def start(self):
        ...
        self.write_to_excel(self.all_avail_items, self.all_avail_element, u"foreign_cosmetrics_elements", self.save_filepath, 'inland_cosmetics_elements.xls')
